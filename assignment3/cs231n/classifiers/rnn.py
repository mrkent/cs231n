...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    word_embedded, word_cache = word_embedding_forward(captions_in, W_embed)
    if self.cell_type == 'rnn':
      rnn_out, rnn_cache = rnn_forward(word_embedded, h0, Wx, Wh, b)
  ...
  def sample(self, features, max_length=30):
    ...
    for i in xrange(1, max_length):
      ...
      if self.cell_type == 'rnn':
        ...
        h[:, i, :], c[:, i, :], _ = lstm_step_forward(word_embeddings[:, i - 1, :], h[:, i - 1, :], c[:, i - 1, :], Wx,
                                                      Wh, b)
